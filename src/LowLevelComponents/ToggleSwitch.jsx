	...
	return (
		<>
			<input
				...
				type="checkbox"
				id={id}
				className="relative mt-1 h-4 w-[3.25rem] cursor-pointer appearance-none rounded-full border border-transparent bg-slate-600 ring-1 ring-transparent transition-colors duration-200 ease-in-out  before:inline-block before:h-6 before:w-6 
