...
function Navbar({ navPage, setNavPage }) {
	...
	return (
		<div
			className={`${themeColour?.backgroundOpaque} absolute bottom-5 left-1/2 z-20 flex h-[4rem] w-[11rem] -translate-x-1/2 items-center justify-center rounded-full py-1`}
		>
			<div
