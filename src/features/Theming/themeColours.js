export const themeColours = {
	seoulInsideDay: {
		...
		overlapBackgroundOpaque: `overlap:bg-amber-100 overlap:bg-opacity-100`,
		overlapBackgroundContrast: `overlap:bg-amber-200 overlap:bg-opacity-100`,
		...
		button: `bg-amber-200`,
		// overlapButton: `overlap:bg-indigo-500`,
	...
	seoulInsideNight: {
		...
		overlapBackgroundOpaque: `overlap:bg-indigo-700 overlap:bg-opacity-100`,
		overlapBackgroundContrast: `overlap:bg-indigo-500 overlap:bg-opacity-100`,
